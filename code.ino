...
#define key 10    // Digital pin for vehicle key
//#define key LED_BUILTIN    // Digital pin for vehicle key
#define mot LED_BUILTIN    // analog pin for Engine motor
//#define mot A3    // analog pin for Engine motor
#define Switch 12 // Digital pin for activating system
#define alrm  LED_BUILTIN  // Digital pin for Buzzer
#define tlit 13
...
void loop()  //Main loop
{
  ...
  while(1)
  {
    ...
    if(temp==HIGH)  //condition for Activate the System
    {
      ...
      else if((digitalRead(key)!=HIGH)&&(((valx>265 &&valx<280 )&&(valy>310 &&valy<340)&&(valz>310 &&valz<340)) || ((valx>340 &&valx<395 )&&(valy>310 &&valy<350)&&(valz>310 &&valz<340))))
...
void get_gsm() //function for reading GPS data and sending theft location through SMS
{
  ...
  Serial.println("AT+CMGS=\"+917433030937\"\r"); // Replace x with mobile number
  delay(1000);
